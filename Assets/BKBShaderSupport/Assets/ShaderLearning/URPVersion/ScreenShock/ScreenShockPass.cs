...
class ScreenShockPass : ScriptableRenderPass
{
    Material m_material;
    ...
    public ScreenShockPass(RenderPassEvent renderEvent , Shader m_shader)
    {
    ...
    public ScreenShockVolume volume;
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        volume = stack.GetComponent<ScreenShockVolume>();    //获取Volume上的组件上添加的脚本
        if(volume == null)
        {
    ...
    private void OnRenderImage(CommandBuffer cmd , RenderingData renderingData) {
        ...
        m_material.SetVector("_Center" , volume._Center.value); 
        m_material.SetFloat("_Radius" , volume._Radius.value);
        m_material.SetFloat("_Aspect"   , volume._Aspect.value);
        m_material.SetFloat("_Width"   , volume._Width.value);
